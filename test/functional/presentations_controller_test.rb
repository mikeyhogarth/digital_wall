...
class PresentationsControllerTest < ActionController::TestCase
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post :create, presentation: { client_id: @presentation.client_id, description: @presentation.description, name: @presentation.name }
    end
  ...
  test "should update presentation" do
    put :update, id: @presentation, presentation: { client_id: @presentation.client_id, description: @presentation.description, name: @presentation.name }
    assert_redirected_to presentation_path(assigns(:presentation))
  end
