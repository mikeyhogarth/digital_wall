...
class ConceptsControllerTest < ActionController::TestCase
  ...
  test "should create concept" do
    assert_difference('Concept.count') do
      post :create, concept: { description: @concept.description, image_url: @concept.image_url, name: @concept.name }
    end
  ...
  test "should update concept" do
    put :update, id: @concept, concept: { description: @concept.description, image_url: @concept.image_url, name: @concept.name }
    assert_redirected_to concept_path(assigns(:concept))
  end
